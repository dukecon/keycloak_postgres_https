    ...
    <#elseif section = "form">
        <#if realm.password>
            <form action="${url.loginAction}" method="post" class="pure-form pure-form-aligned">
                ...
                <!-- TODO: Clean this up! -->
                <div class="pure-control-group"><em>Please use your Javaland user account. If you have not yet registered, please visit<br><a href="https://www.javaland.eu/de/login/registrierung/">the Javaland registration page</a>.<br>Come back here after successful registration.</em></div>
